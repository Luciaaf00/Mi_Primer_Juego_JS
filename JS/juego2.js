...
function bloquearTarjetas(){
    for (let i=0;i<=29;i++){
        ...
        tarjetaBloqueada.innerHTML=`<img src="./images/fotos_juego2/${numeros[i]}.png" alt="emoji de instituto">`;
...
function destapar(id) {
    ...
    if(tarjetasDestapadas == 1){
        ...
        tarjeta1.innerHTML= `<img src="./images/fotos_juego2/${primerResultado}.png" alt="emoji de instituto">`;
        normalAudio.play();
        ...
        tarjeta2.innerHTML=`<img src="./images/fotos_juego2/${segundoResultado}.png" alt="caras de instituto">`;
